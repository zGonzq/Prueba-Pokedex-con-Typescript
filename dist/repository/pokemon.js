...
class PokemonRepository {
    constructor() {
        this.connection = new pokemonDB_1.Conexion();
    }
    getPokemonById(id) {
    ...
    createPokemon(pokemon) {
        return __awaiter(this, void 0, void 0, function* () {
            const conn = yield this.connection.connect();
            const [rows] = yield conn.query("INSERT INTO pokemon (pokename, HP, attack, defense, spattack, spdefense, speed, dualtype) VALUES (?, ?, ?, ?, ?, ?, ?, ?)", [pokemon.pokename, pokemon.HP, pokemon.attack, pokemon.defense, pokemon.spattack, pokemon.spdefense, pokemon.speed, pokemon.dualtype]);
            return rows;
        });
    }
